...
if res_gp_mo.X is not None:
    ...
    scipy.io.savemat('new_problem_ieee123bus_result_20cp_250ps_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.mat',results)
...
plt.yscale("log")
plt.savefig('new_problem_ieee123bus_result_20cp_250ps_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.png',dpi=75)
plt.show()
