...
if res_gp_mo.X is not None:
    ...
    scipy.io.savemat('new_problem_hce_result_20cp_1000ps_200os_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.mat',results)
...
plt.yscale("log")
plt.savefig('new_problem_ieee123bus_result_20cp_1000ps_200os_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.png',dpi=75)
plt.show()
