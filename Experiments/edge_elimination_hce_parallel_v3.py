...
if res_gp_mo.X is not None:
    ...
    scipy.io.savemat('new_problem_hce_result_20cp_200ps_20os_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.mat',results)
...
plt.yscale("log")
plt.savefig('new_problem_hce_result_20cp_200ps_20os_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.png',dpi=75)
plt.show()
