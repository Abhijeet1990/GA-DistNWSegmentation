...
nsga2_alg = NSGA2(
    ...
    crossover=get_crossover("bin_k_point", prob=0.9, n_points=30),
    mutation=get_mutation("bin_bitflip"),
    eliminate_duplicates=True)

max_no_subgraphs=15
min_no_subgraphs=3
min_node_partition = 4
...
if res_gp_mo.X is not None:
    ...
    scipy.io.savemat('new_problem_ieee34bus_der_result_30cp_250ps_80os_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.mat',results)
...
plt.yscale("log")
plt.savefig('new_problem_ieee34bus_der_result_30cp_250ps_80os_'+str(max_no_subgraphs)+'_'+str(min_no_subgraphs)+'_'+str(min_node_partition)+'.png',dpi=75)
plt.show()
